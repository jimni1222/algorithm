/*
    ...
    The hotel has floors numbered from 0 (ground floor) to M. The elevator has a maximum capacity of X poeple and a weight limit of Y. 
    There are N poeple gathered at the ground floor, standing in a queue for the elevator.
    ...
    (The queue order cannot be changed even if there is room in ther elevator for a particular person from the middle of the queue.)
    ...
    The weight A and target floors B are :
    A[0] = 60     B[0] = 2
    A[1] = 80     B[1] = 3
    A[2] = 40     B[2] = 5
    The elevator will take the fist two passengers together, stop at the 2nd and 3rd floors, then return to the ground floor.
    ...
    that, given arrays A and B consisting of N integers, and numbers X, Y and M as described above, returns the total number of times the elevator stops.
    ...
    A[3] = 80     B[3] = 2
    A[4] = 20     B[4] = 3
    the function should return 6, as the elevator will move in two stages: with the fist three people and then with the two remaining people.
